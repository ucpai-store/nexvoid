...
echo "     # DRY-RUN (preview phantom profit):"
echo "     bun run scripts/refund-orphan-profit.ts"
echo ""
echo "     # EKSEKUSI (refund phantom profit):"
echo "     bun run scripts/refund-orphan-profit.ts --apply"
echo ""
echo "     # Per-user specific:"
echo "     bun run scripts/refund-orphan-profit.ts --user=62812xxxx --apply"
echo ""
...
echo "     ★ Delete Investment/Purchase via admin sekarang AUTO-REFUND profit ke balance user"
echo ""
