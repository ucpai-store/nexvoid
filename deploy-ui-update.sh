...
echo ""
echo "Changes live:"
echo "  ✓ Deposit success modal: WhatsApp button REMOVED"
echo "  ✓ Replaced with 'Deposit Sedang Diproses' message"
echo "  ✓ Deposit history: 'Chat Admin' button REMOVED"
echo "  ✓ Upload hint text cleaned (no more 'kirim via WhatsApp')"
echo ""
