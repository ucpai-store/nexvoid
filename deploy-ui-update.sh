...
echo ""
echo "Changes live:"
echo "  ✓ Fitur panduan/tutorial DIHAPUS sepenuhnya (tidak ada tombol Mulai Panduan)"
echo "  ✓ Sistem tier (paket=produk) — aturan no-duplicates:"
echo "      • Boleh beli tier mana saja yg belum dimiliki (TIDAK harus berurutan)"
echo "      • Setiap tier hanya bisa dibeli SEKALI"
echo "      • 1 paket aktif saja (beli baru → tier lama jadi 'Sudah Dimiliki')"
echo "  ✓ Profit masuk otomatis jam 00:00 WIB sesuai paket aktif hari ini"
echo "  ✓ Banner PaketPage: '1 Paket Aktif Saja · Tidak Boleh Beli Yg Sudah Dimiliki'"
echo "  ✓ Hapus status 'Terkunci' — semua tier unbought sekarang 'Beli Sekarang'"
echo ""
