#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════
#  NEXVO — Hot UI Update Script (self-contained)
...
#  Usage:
#    bash deploy-ui-update.sh           # local (if you have the repo)
#    curl -fsSL <url>/deploy-ui-update.sh | bash   # works on fresh VPS
# ═══════════════════════════════════════════════════════════════
set -eo pipefail
...
# Run deploy.sh with --skip-build (hot update, no rebuild)
exec bash "$DEPLOY_SH" --skip-build "$@"
