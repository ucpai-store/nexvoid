...
echo "  • Admin Payment page now only shows QRIS + USDT"
...
echo "  • Deposit-only info banner added to admin page"
echo "  • Legacy bank/ewallet/crypto methods hidden (with notice)"
echo ""
