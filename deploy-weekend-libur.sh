#!/bin/bash
# ════════════════════════════════════════════════════════════════
# NEXVO Deploy: Weekend Libur (Sabtu & Minggu OFF)
# ════════════════════════════════════════════════════════════════
# PERUBAHAN:
#   - Semua aktivitas (deposit, withdrawal, profit) LIBUR di Sabtu & Minggu
#   - Deposit API: block dengan pesan "Deposit diblokir pada hari Sabtu & Minggu..."
#   - Withdraw API: block dengan pesan "Withdrawal diblokir pada hari Sabtu & Minggu..."
#   - Profit cron: skip profit distribution di Sabtu & Minggu (no daily profit)
#   - UI: WeekendNoticeBanner di halaman Deposit, Withdraw, Profit (auto-show di weekend)
...
echo "═══════════════════════════════════════════════════"
echo "  NEXVO Deploy: Weekend Libur (Sabtu & Minggu OFF)"
echo "  Semua aktivitas libur di akhir pekan"
echo "═══════════════════════════════════════════════════"
...
echo "═══════════════════════════════════════════════════"
echo ""
echo "📌 PERILAKU BARU (Weekend Libur):"
echo "  • Sabtu & Minggu = SEMUA aktivitas LIBUR"
echo "  • Deposit  → diblokir dengan pesan jelas"
...
echo "  • UI: banner kuning muncul otomatis di Deposit/Withdraw/Profit saat weekend"
echo ""
