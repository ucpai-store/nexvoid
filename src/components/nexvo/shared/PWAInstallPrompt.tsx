        ...
        {showFab && !showIOSGuide && (
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative flex items-center gap-2 pl-4 pr-5 py-3 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground rounded-full shadow-[0_4px_20px_rgba(184,150,15,0.3)] hover:shadow-[0_4px_30px_rgba(184,150,15,0.4)] transition-all"
            >
              {installing ? (
                <>
                  <motion.div
                    ...
                    className="w-5 h-5 border-border border-primary-foreground/30 border-t-primary-foreground rounded-full"
                  />
              ...
              {!installing && (
                <span className="absolute -top-1 -right-1 w-3 h-3">
                  <span className="absolute inline-flex h-full w-full rounded-full bg-cardmerald-400 opacity-75 animate-ping" />
                  <span className="relative inline-flex rounded-full h-3 w-3 bg-cardmerald-500" />
                </span>
              )}
            </motion.button>
          </motion.div>
            ...
            >
              <div className="pointer-events-auto max-w-sm mx-auto" onClick={(e) => e.stopPropagation()}>
                <div className="relative bg-gradient-to-b from-card to-secondary border border-primary/30 rounded-2xl p-6 shadow-[0_0_40px_rgba(184,150,15,0.1)]">
                  ...
                  <button
                    onClick={handleIOSGuideClose}
                    className="absolute top-3 right-3 w-7 h-7 rounded-full bg-foreground/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:bg-foreground/10 transition-all"
                  >
