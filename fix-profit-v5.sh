#!/bin/bash
# ════════════════════════════════════════════════════════════════
# NEXVO — FIX PROFIT v5 (BULLETPROOF, NO STATUS FILTER)
# ════════════════════════════════════════════════════════════════
#
...
#
# 🎯 ROOT CAUSE yang di-fix v5:
#   v4 masih filter `status: "active"` → kalau di VPS beda dikit, tetep 0
#   v5 GAK filter status sama sekali — scan SEMUA purchase + investment
#   Pakai endDate sebagai source of truth (bukan status string)
#
# CARA PAKAI:
#   cd /var/www/nexvo && bash fix-profit-v5.sh
# ════════════════════════════════════════════════════════════════
...
echo ""
echo "╔══════════════════════════════════════════════════╗"
echo "║  NEXVO FIX PROFIT v5 — BULLETPROOF               ║"
...
# ─── BACKUP DB ──
BACKUP_FILE="db/custom.db.backup-v5-$(date +%Y%m%d-%H%M%S)"
...
(async () => {
  ...
  // ═══════════════════════════════════════════════════════════
  console.log("═══════════════════════════════════════════════════");
  console.log("🎉 FIX PROFIT v5 SELESAI!");
  console.log("═══════════════════════════════════════════════════");
  console.log("");
  console.log("🔒 KEAMANAN DATA:");
  console.log("   • TIDAK ada user/purchase/investment yang dihapus");
  console.log("   • Backup DB: " + (process.env.BACKUP_FILE || "db/custom.db.backup-v5-*"));
  console.log("");
